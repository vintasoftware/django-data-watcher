...
class TestAbstractWatcher(TestCase):
    def setUp(self) -> None:
        ...
        setattr(MyWatcher, '_watched_operation', watched_operation)
    ...
    def test_run_without_additional_params(self):
        ...
        self.operation.assert_called_once_with(target)
    ...
    def test_run_with_additional_params(self):
        ...
        self.operation.assert_called_once_with(target, *args, **kwargs)
    ...
    def test_is_overriden(self):
        ...
        self.watcher.run = lambda operation, target, *args, **kwargs: None
        self.watcher.to_queryset = lambda target: None
